...
export class JogoDaVelhaService {
  ...
  // Esse bloco de codigo trabalha com os estados do tabuleiro
  private readonly TAM_TAB: number = 3;
  private readonly X: number = 1;
  private readonly O: number = 2;
  private readonly VAZIO: number = 0;

  // O tabuleiro é um array multi dimensional
  private tabuleiro: any;
  // O numero de movimentos deverá ser computado pois se a partida chegar em 9 movimentos e o jogo não foi finalizado
  // significa que ocorreu um empate e ninguem venceu
  private numMovimentos: number;
  // Usado para armazenar as posições da vitoria
  private vitoria: any;


  private _jogador: number;
  // As variáveis abaixo representam as flags das telas que deveram ser exibidas por isso são valores booleanos
  ...
  inicializarTabuleiro(): void {
    // Igualando a variável tabuleiro a ao tamanho do tabuleiro
    // Inicializando o array das posições do tabuleiro com valores zerados
  ...
  jogar(posX: number, posY: number): void {
    // jogada inválida
    // Verifica se alguem já jogou na posição e invalida a jogada
